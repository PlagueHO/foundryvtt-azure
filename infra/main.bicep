...
var containerAppDdbProxyName string = take('${abbrs.appContainerApps}${environmentName}ddbproxy', 32)
...
module storageAccount 'br/public:avm/res/storage/storage-account:0.32.0' = {
  ...
  params: {
    ...
    location: location
    allowSharedKeyAccess: true // Required for all compute services to mount the Azure Files volume using Shared Key (SMB)
    networkAcls: {
